...
${antiBadword ? 'Yes' : 'No'} Anti Badword
${global.db.data.chats[m.chat].delete ? 'Yes' : 'No'} Anti Delete
${read ? 'Yes' : 'No'} Autoread
${isBanned ? 'Yes' : 'No'} Banned
${descUpdate ? 'Yes' : 'No'} Deskprisi
${detect ? 'Yes' : 'No'} Detect
${download ? 'Yes' : 'No'} Download
${getmsg ? 'Yes' : 'No'} Getmsg
${stiker ? 'Yes' : 'No'} Stiker
${viewonce ? 'Yes' : 'No'} Viewonce
